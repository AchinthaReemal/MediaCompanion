...
public class DownloadClient extends SwingWorker<Void, Void>{
    ...
    public DownloadClient(String filename, String downloadlink, String tvshowimage) {
    ...
    public void setCompletion(final JLabel completion){
        client.setCompletionLevel(completion);
    }
